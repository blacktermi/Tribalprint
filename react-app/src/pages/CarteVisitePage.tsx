  ...
  async function handleOrder() {
    ...
    try {
      ...
      const payload = buildOrderPayload({
        ...
        items: [
          {
            product_slug: 'carte-visite',
            product_label: 'Cartes de visite',
            quantity: packs,
            unit_price: unitPackPrice,
            options: { impression, pelliculage, bords_arrondis: bordsArrondis, pack_size: 100 },
          },
        ],
      ...
      console.error('createOrder failed (carte-visite), fallback:', e)
      navigate(confirmationTo)
    } finally {
      setSubmitting(false)
    }
  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-8">
      <div className="grid gap-8 md:grid-cols-2">
        ...
        <div>
          <h1 className="text-2xl font-semibold tracking-tight">Cartes de visite</h1>
          <p className="mt-1 text-slate-600 text-sm">100 cartes recto-verso: 15 000 FCFA. Format 85 × 55 mm. Impression recto ou recto-verso. Pelliculage mat ou brillant. Option bords arrondis: +3 000 FCFA par pack de 100.</p>
          ...
          <div className="mt-6 space-y-6">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="text-xs text-slate-500">Format: 85 × 55 mm</div>
            </div>

...
export default function PostersPage() {
  ...
  const params = new URLSearchParams({ product: 'posters', zone: String(zone), commune, subtotal: String(subtotal), discount: String(discountAmount), delivery: String(delivery), total: String(total), name: fullName.trim(), phone: phone.trim(), delivery_date: deliveryInfo.iso, delivery_window: deliveryInfo.window })
  ...
  }, [zone, commune, subtotal, discountAmount, delivery, total, fullName, phone, quantities, photosByFormat, shapesByFormat, customItems])

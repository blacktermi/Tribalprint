    ...
    <div className="mx-auto max-w-6xl px-4 py-8">
      ...
      {!hasQuery && (
        <div className="mt-8 space-y-8">
          ...
          <StockSection title="TB — Tableaux Aluminium en stock (A3)" items={[1,2,3,4,5,6].map(n => ({src: `/img/TB${n}.jpg`, to: `/boutique/stock/aluminium/TB${n}`}))} />
          <StockSection title="MT — Metal Posters en stock (A3)" items={[1,2,3,4,5,6].map(n => ({src: `/img/MT-${n}.jpg`, to: `/boutique/stock/metal/MT-${n}`}))} />
        </div>
      )}

...
export default function EtiquettePage() {
  ...
  }, [details, qty, unitPrice, subtotal, discountAmount, delivery, total, zone, commune, fullName, phone, email, deliveryInfo.iso, deliveryInfo.window])
          ...
          <div className="mt-6 space-y-6">
            <div className="grid gap-4 md:grid-cols-3">
              <div className="md:col-span-2">
                ...
                <input type="text" className="mt-1 w-full rounded-md border border-slate-300 px-3 py-2 text-sm" value={fullName} onChange={(e) => setFullName(e.target.value)} placeholder="Ex: N'Guessan Linda" />
              ...
              <div>
                ...
                <input type="tel" className="mt-1 w-full rounded-md border border-slate-300 px-3 py-2 text-sm" value={phone} onChange={(e) => setPhone(e.target.value)} placeholder="Ex: +225 07 88 99 00" />
            ...
            <div>
              ...
              <textarea className="mt-1 w-full rounded-md border border-slate-300 px-3 py-2 text-sm" rows={3} value={details} onChange={(e) => setDetails(e.target.value)} placeholder="Ex: 5 × 8 cm, rouleaux, papier adhésif, impression couleur" />

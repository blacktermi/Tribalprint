    ...
    <div className="mx-auto max-w-6xl px-4 py-8">
      <div className="grid gap-8 md:grid-cols-2">
        ...
        <div>
          ...
          <p className="mt-1 text-slate-600 text-sm">100 cartes recto-verso: 15 000 FCFA. Format: 10 × 10 cm. Pelliculage mat ou brillant. Option bords arrondis: +3 000 FCFA par pack de 100.</p>

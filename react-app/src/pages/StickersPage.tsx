      ...
      <div className="grid gap-8 md:grid-cols-2">
        <div>
          <div className="overflow-hidden rounded-xl border border-slate-200">
            <img src={coverSrc} onError={() => setCoverSrc('/img/stickers-cover.svg')} alt="Stickers personnalisés" className="w-full object-cover" />
          </div>
        </div>
        <div>
          <h1 className="text-2xl font-semibold tracking-tight">Stickers personnalisés</h1>
          <p className="mt-1 text-slate-600 text-sm">Pack de 10: 4 000 FCFA.</p>

          <div className="mt-6 space-y-6">
            <div className="grid gap-4 md:grid-cols-3">
              <div className="md:col-span-2">
                <label className="text-sm font-medium">Nom et Prénom <span className="text-red-600">*</span></label>
                <input type="text" className="mt-1 w-full rounded-md border border-slate-300 px-3 py-2 text-sm" value={fullName} onChange={(e) => setFullName(e.target.value)} onBlur={() => setTouched(true)} placeholder="Ex: Dao Mariam" />
              ...
              <div>
                ...
                <input type="tel" className="mt-1 w-full rounded-md border border-slate-300 px-3 py-2 text-sm" value={phone} onChange={(e) => setPhone(e.target.value)} onBlur={() => setTouched(true)} placeholder="Ex: +225 05 55 66 77 88" />
            ...
            <div className="flex items-center gap-3">
              <div className="text-sm font-medium">Packs (×10)</div>
              ...
              <div className="text-sm text-slate-600">{unitPackPrice.toLocaleString()} FCFA / pack de 10</div>
            </div>
            ...
            <div className="rounded-xl border border-slate-200 p-4 text-sm">
              <div className="flex justify-between"><span>{packs} × pack (10 stickers)</span><span>{subtotalPacks.toLocaleString()} FCFA</span></div>
